...
/*************************** Enter your code here ****************************/
	...
	while (*str != '\0') {
		if (xQueueSend(xOutputQueue, (void *)str, 0) != pdPASS) {
			break;
		}
		str++;
	}
...
void vHashingTask(void *pvParameters)
{
    ...
    while (1)
    {
        if (choice != NOP){
			...
			/*****************************************************************************/
				...
				/*************************** Enter your code here ****************************/
						...
						if (xQueueSend(xPoWInQueue, &newProof, 0) != pdPASS) {
							xil_printf("Error: Failed to send data to xPowInQueue\n");
						}
				/*****************************************************************************/
		...
		/*************************** Enter your code here ****************************/
			...
			if (xQueueSend(xPoWInQueue, &hashingProof, 0) != pdPASS) {
...
void vPoWTask(void *pvParameters)
{
	...
	/*************************** Enter your code here ****************************/
		...
		if (xQueueReceive(xPoWInQueue, &powProof, 0) == pdPASS) {
	/*****************************************************************************/
		...
		/*************************** Enter your code here ****************************/
			// TODO 11: Send data to the PoW output queue
				if (xQueueSend(xPoWOutQueue, &powProof, 0) != pdPASS) {
					xil_printf("Error: Failed to send data to xPoWOutQueue.\n");
				}
			}
		/*****************************************************************************/
...
void vOutputTask(void *pvParameters)
{
	...
	/*************************** Enter your code here ****************************/
		...
		if (xQueueReceive(xOutputQueue, &write_to_console, 0) == pdPASS) {
	/*****************************************************************************/
	...
	/*************************** Enter your code here ****************************/
		// TODO 2: Send received data to UART
			XUartPs_Send(&uart, &write_to_console, 1);
		}
	/*****************************************************************************/
	}
}
